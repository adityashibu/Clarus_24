        ...
        >
            {isSmallScreen ? (
                <div className="md:mt-0 -mt-5">
                    <div className="bg-[#ffffff] p-5 rounded-2xl h-[650px] sm:w-[380px] w-full border-2 border-customBlue shadow-card flex items-center justify-center">
    ...
    return (
        <section>
            <div className="flex flex-wrap gap-7 justify-center -mt-[75px]">
                {ciso_services[0].subpoints.slice(3, 6).map((subpoint, index) => (
                    <ServiceCard
                        key={index}
                        index={index + 3}
...
export default SectionWrapper(CISOServices1, "CISOServices1");