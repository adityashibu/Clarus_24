        ...
        <div className={`md:${styles.paddingX} md:ml-[80px] lg:ml-[20px] flex flex-col md:flex-row items-center gap-8`}>
            ...
            >
                <h1 className={`${styles.heroHeadText} text-black`}>
                    <span className="text-customBlue font-aquirebold text-[90%]">Multilingual Helpdesk</span>
                </h1>
                <p className={`${styles.heroSubText} mt-2 text-black-100 font-light font-aquirelight`}>
                    Exceptional Support for Your Users<br className='sm:block hidden' />
                </p>
            </motion.div>
...
export default SectionWrapper(HelpdeskHero, "HelpdeskHero");