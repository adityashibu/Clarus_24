            ...
            <div className="flex flex-col">
              ...
              <ul className="mt-2">
                {backlinks.map((link, index) => (
                  <li
                    key={index}
                    className="mb-2 text-black hover:underline hover:text-customBlue"
                  >
                    <Link
                      to={link.link}
                      className="text-black hover:underline hover:text-customBlue"
                      onClick={() =>
  ...
  return (
    <section id="our-services">
      <motion.div variants={textVariant()}>
        ...
        >
          Explore our array of services that are designed to help you achieve
          your business goals. Our services are tailored to meet your specific
          needs and requirements, ensuring that you get the best possible
          results.
        </motion.p>
      </motion.div>
      <div
        className="mt-20 grid grid-cols-1 sm:grid-cols-2 gap-10 justify-center mx-auto"
